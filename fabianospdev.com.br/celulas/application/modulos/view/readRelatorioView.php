...
<a href="index.php?page=modulos_view_relatorioA" style="background-color: green;" class="btn btn-primary btn-novo"><span class="glyphicon glyphicon-plus"></span> Novo Relatório</a>
