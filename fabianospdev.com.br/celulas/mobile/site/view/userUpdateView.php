...
<div class="navegacao">
	...
	<span><p id="aviso" >Alguns campos são criptografados para segurança</p></span>
...
<div style="margin: 10%;" id="modal-apaga" class="modal fade modal-dialog-centered" role="dialog">
...
style="background-color:red;margin: 15px auto 0px auto;width: 100px;height: 40px;font-size: 12px;" class="btn btn-primary btn-lg btn-block">
 Apagar célula</a>
      ...
      <p style="display: inline-block; float: left;color:green;font-style: inherit;font-size:12px;">Esse registro ainda poderá ser recuperado</p>
