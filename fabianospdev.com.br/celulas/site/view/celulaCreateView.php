...
if(isset($_POST['celCelula'])){
    ...
    switch ($logtipo) {
                case 1: $celin->insertCelula();
                   break;
                case 2: $celin->coordenadorinsertCelula();
                   break;
                case 3: $celin->pastorinsertCelula();
                   break;
                case 4: $celin->liderinsertCelula();
                   break;
                case 5: $celin->colaboradorinsertCelula();
                   break;
                case 6: $celin->comuminsertCelula();
                   break;
                case 7: '0';
                   break;
                default:
