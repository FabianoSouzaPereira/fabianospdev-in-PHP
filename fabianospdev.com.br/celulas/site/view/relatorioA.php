...
if (isset($_POST['base'])){
	...
	$logtipo=$_SESSION['tipo']; 
        switch ($logtipo) {
                case 1: $rel->insert();
                   break;
                case 2: $rel->coordenadorinsert();
                   break;
                case 3: $rel->pastorInsert();
                   break;
                case 4: $rel->liderinsert();
                   break;
                case 5: $rel->colaboradorinsert();
                   break;
                case 6: $rel->comuminsert();
                   break;
                case 7: '0';
                   break;
                default:
...
<div class="grupoRel">
        ...
        <div class="form-row" style="margin: 50px auto 0px 50px;">
        	...
        	<div class="form-group col-md-4" style="margin-left: 0px; margin: 30px auto 0px auto;">
        		...
        		<input type="number" name="soma" id="soma"  value="<?php echo @$ret[0]['relTotal'];?>" min="0" style="float:m; width: 100px;margin-left: 10px;" readonly/>
        	</div>
        	<div class="form-group col-md-4" style="margin-left: 0px; margin: 30px auto 0px auto;">
	...
	<div id="cbEstudo" name="cbEstudo" class="form-row" value="cbEstudo" style="margin: 50px auto 0px 50px;">
		...
		<div id="cbReconcilhacao" name="cbReconcilhacao" value="cbReconcilhacao" class="form-group col-md-4" style="margin-top: 0px;margin-left:0px;">
			<label for="cbNao">Alguém se Reconciliou com Cristo? </label><br>
			<label for="cbSim" style="margin-left:30px;">Sim</label>
