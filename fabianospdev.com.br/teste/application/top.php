<ul id="menu" class="nav nav-pills nav-justified navbar-fixed-top"> 
	...
	<li role="presentation" class="dropdown"><a href="#" data-toggle="dropdown">Localidades<span class="caret"></span></a>
	...
	<li role="presentation" class="dropdown"> 
		...
		<ul class="dropdown-menu"> 
			<li><a href="relatorios/vendasPDF.php">Vendas</a></li> 
			<li><a href="relatorios/clientesPDF.php">Clientes</a></li> 
			<li><a href="relatorios/funcionariosPDF.php">Funcionários</a></li> 
		</ul> 
	</li> 
</ul>