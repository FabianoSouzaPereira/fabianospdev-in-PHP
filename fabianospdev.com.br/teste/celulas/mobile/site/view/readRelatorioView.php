...
<div class="tela">
   ...
   <div class="formato panel panel-warning">
      ...
      <div class="panel-body">	
        	<a href="" data-toggle="modal" data-target="#modal-novoRelatorio"><button id="novorelatorio" style="background-color: green; margin-bottom:5px;"; class="btn btn-primary btn-novo"><span class="glyphicon glyphicon-plus"></span> Novo relatório</button></a>
            <input type="text" id="pesquisarel" class="form-control  sombra-efe" style="display:inline-block;width:200px;"  placeholder="Pesquisa...">
        <table class="listagem table table-bordered table-striped table-responsive"  style="margin-top:10px;width:100%;">
        	<thead>
        	<tr>
        		<th></th>     		
            ...
            try{
                ...
                if(is_array($ret)){
                    Foreach($ret as $raw) {
                        ...
                        echo "<tr>"; 
                        echo "<td style='text-transform:uppercase; color: black;width:20px;'>", $sec++ ,"</td>";
                        echo "<td style='text-transform:uppercase; color: black;'>", $celula,"</td>";
                        echo "<td style='text-transform:uppercase; color: black;width:20px;'>", Validador::bancoToUser( $data),"</td>";
                        echo "<td style='width:20px;'><a href='index.php?page=site_view_relatorioUpdateView&id=$id&c=$celula' class='btn btn-primary btn-lista'><span class='glyphicon glyphicon-edit'></span></a></td>";
                        echo "</tr>";
                    }
