...
<a href="index.php?page=site_view_userCreateView" style="background-color: green;" class="btn btn-primary  btn-novo"><span class="glyphicon glyphicon-plus"></span> Novo Usuário</a>
   <a href="" data-toggle="modal" data-target="#modal-associaCelula">
...
<input type="text" id="pesquisauser" class="form-control sombra-efe" style="display:inline-block;width:200px;"  placeholder="Pesquisa...">
...
<thead>
    ...
    $sec=1;
        if(is_array($ret)){
            ...
            echo "<td style='text-transform:uppercase; color: black;'>",$strTipo,"</td>";
            echo "<td style='text-transform:uppercase; color: black;'>", $bloqueado,"</td>";
            echo "<td><a href='index.php?page=site_view_userDetailsView&id=$id' class='btn btn-primary btn-lista'><span class='glyphicon glyphicon-plus'></span></a></td>";
	...
	<tfoot>
		<tr>
			<th colspan="13" class="text-center"><?php  date('d/m/Y h:i:s'); ?></th><td id=""></td>
		</tr>
	</tfoot>
 </table>
 </div>
...
<div style="margin-top: 5%;" id="modal-associaCelula" class="modal fade modal-dialog-centered" role="dialog">
    ...
    <div class="modal-content">
      <div id="selects" class="modal-header">
        ...
        <h2 class="modal-title">Para qual celula ? </h2>
         <select id="usuarios" name="usuarios" class="form-control" style="margin:20px auto 0px auto;width:400px;height:45px;font-size:14px;">
      ...
      <div class="modal-body" >
		...
		<a href="index.php?pag=site_view_associausuario"
			style="background-color:green;margin: 10px auto 0px auto;width: 200px;height: 60px;font-size: 25px;" 
