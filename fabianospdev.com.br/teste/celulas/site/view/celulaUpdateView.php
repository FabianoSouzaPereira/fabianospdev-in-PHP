...
if(isset($_GET['id'])){
    $id=$_GET['id'];
	   ...
	   $logtipo=$_SESSION['tipo'];
        ...
        switch ($logtipo) {
                case 1: $cel->readWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 2: $cel->coordenadorReadWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 3: $cel->pastorReadWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 4: $cel->liderReadWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 5: $cel->colaboradorReadWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 6: $cel->comumReadWholebyId($id);
                        $ret = $cel->getDadosWhole();
                   break;
                case 7: '0';
                   break;
...
if(isset($_POST['celCelula'])){
    ...
    switch ($logtipo) {
                case 1: $celup->updateCelulaforId($id);
                   break;
                case 2: $celup->coordenadorUpdateCelulaforId($id);
                   break;
                case 3: $celup->pastorUpdateCelulaforId($celId);
                   break;
                case 4: $celup->liderUpdateCelulaforId($id);
                   break;
                case 5: $celup->colaboradorUpdateCelulaforId($id);
                   break;
                case 6: $celup->comumUpdateCelulaforId($id);
                   break;
                case 7: '0';
                   break;
                default:
